...
const translations: Record<Language, Translations> = {
  en: {
    ...
    startYourProject: "Contact RR Constructions",
    contactDescription: "Share your project requirements and our leadership team will get back to you within 24 hours.",
    visitOurStudio: "Registered Office",
    callUs: "Phone",
    emailUs: "Email",
    workingHours: "Office Hours",
    interactiveMap: "Interactive Map",
    sendUsMessage: "Send Us a Project Inquiry",
    fullName: "Full Name",
    emailAddress: "Email Address",
    phoneNumber: "Phone Number",
    serviceInterestedIn: "Project Segment",
    selectService: "Select project segment",
    projectDetails: "Project Specifications & Scope",
    tellUsAboutProject: "Tell us about built-up area, site location, timeline, and structural scope...",
    sendMessage: "Submit Project Inquiry",
    thankYouMessage: "Inquiry Received Successfully",
    thankYouDescription: "Thank you for reaching out to RR Constructions & RR Infra. Our team will contact you within 24 hours.",
    ...
    subscribeText: "Subscribe for project updates, construction insights, and exclusive offers.",
    join: "Join",
  ...
  hi: {
    ...
    startYourProject: "आरआर कंस्ट्रक्शन से संपर्क करें",
    contactDescription: "अपनी परियोजना की आवश्यकताएं साझा करें और हमारी नेतृत्व टीम 24 घंटों के भीतर आपसे संपर्क करेगी।",
    visitOurStudio: "पंजीकृत कार्यालय",
    callUs: "फोन",
    emailUs: "ईमेल",
    workingHours: "कार्य समय",
    interactiveMap: "इंटरैक्टिव मैप",
    sendUsMessage: "हमें परियोजना पूछताछ भेजें",
    fullName: "पूरा नाम",
    emailAddress: "ईमेल पता",
    phoneNumber: "फोन नंबर",
    serviceInterestedIn: "परियोजना सेगमेंट",
    selectService: "परियोजना सेगमेंट चुनें",
    projectDetails: "परियोजना विनिर्देश और स्कोप",
    tellUsAboutProject: "बिल्ट-अप क्षेत्र, साइट स्थान, समय-सीमा और संरचनात्मक स्कोप के बारे में बताएं...",
    sendMessage: "परियोजना पूछताछ भेजें",
    thankYouMessage: "पूछताछ सफलतापूर्वक प्राप्त हुई",
    thankYouDescription: "आरआर कंस्ट्रक्शन एंड आरआर इंफ्रा को धन्यवाद। हमारी टीम 24 घंटों के भीतर आपसे संपर्क करेगी।",
    ...
    subscribeText: "परियोजना अपडेट, निर्माण अंतर्दृष्टि और विशेष ऑफ़र के लिए सदस्यता लें।",
    join: "जुड़ें",
