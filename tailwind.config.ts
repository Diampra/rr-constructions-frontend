  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "cinematic-down": {
          "0%": { opacity: "0", transform: "translateY(-70px) scale(1.04)" },
      ...
      animation: {
        ...
        "cinematic-down": "cinematic-down 1.2s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "cinematic-up": "cinematic-up 1.4s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "marquee-slide": "marquee-slide 20s linear infinite",
      },
      boxShadow: {
